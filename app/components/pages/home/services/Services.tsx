          ...
          <div className={styles.services__wrapper_main}>
            ...
            >
              ...
              >
                ...
                <svg className={styles.services__card_image} xmlns="http://www.w3.org/2000/svg" width="122"
                  height="122" viewBox="0 0 287 265" fill="none">
                  <rect x="2" y="2" width="283" height="261" rx="18" stroke="white" stroke-width="2" />
                  <mask id="path-2-inside-1_3_23" fill="white">
                    <rect x="58" y="102" width="31" height="31" rx="2" stroke-width="2" />
                  </mask>
                  <rect x="58" y="102" width="31" height="31" rx="2" stroke="white" stroke-width="2" mask="url(#path-2-inside-1_3_23)" />
                  <rect x="168" y="15" width="27" height="27" rx="13.5" stroke="white" stroke-width="2" />
                  <rect x="240" y="15" width="27" height="27" rx="13.5" stroke="white" stroke-width="2" />
                  <rect x="204" y="15" width="27" height="27" rx="13.5" stroke="white" stroke-width="2" />
                  <mask id="path-6-inside-2_3_23" fill="white">
                    <rect x="58" y="144" width="31" height="31" rx="2" stroke-width="2" />
                  </mask>
                  <rect x="58" y="144" width="31" height="31" rx="2" stroke="white" stroke-width="2" mask="url(#path-6-inside-2_3_23)" />
                  <path d="M2.5 55H285" stroke="white" stroke-width="2" />
                  <path d="M30 55V224H248.5V55" stroke="white" stroke-width="2" />
                  <path d="M63 2.5V55" stroke="white" stroke-width="2" />
                </svg>
              </div>
            </AnimBorder>
            <AnimBorder

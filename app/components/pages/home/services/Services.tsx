              ...
              <div className={`${styles.services__main_card}`}>
                ...
                >
                  ...
                  <rect
                    ...
                    stroke="white"
                    strokeWidth="2"
                    mask="url(#path-6-inside-2_3_23)"
                  />
                  <path d="M2.5 55H285" stroke="white" strokeWidth="2" />
                  <path
                    d="M30 55V224H248.5V55"
                    stroke="white"
                    strokeWidth="2"
                  />
                  <path d="M63 2.5V55" stroke="white" strokeWidth="2" />
                </svg>
              </div>
            </AnimBorder>
            <AnimBorder

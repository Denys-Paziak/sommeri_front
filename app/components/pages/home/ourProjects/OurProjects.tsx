...
export default  function Page({posts, categories}) {
  ...
  const filteredPosts = activeCategory === "All"
      ? posts.data
      : posts.data.filter(project => project.Category.Name === activeCategory);
                  ...
                  <div className={styles.projects__main_categories}>
                    <ul className={styles.projects__categories_list}>
                      ...
                      {categories.data.map((categori) => {
                        return <li key={categori.Name}
                                   className={`${styles.projects__category_item} ${activeCategory === categori.Name && styles.active}`}
                                   onClick={() => {
                          ...
                          >
                            ...
                            >
                              <div className={styles.project__item_banner}>
                                <Image src={backHost + project.Preview.url} alt={"project img"} width={500} height={500}
                              ...
                              <div className={styles.project__item_info}>
                                ...
                                <p className={styles.project__info_categories}>
                                  ...
                                  {project.technologies.map((technologi) => {
                                    return <span key={technologi.Name} className={styles.project__categories_item}>
                                    {technologi.Name}
                                  </span>
                                  })}
